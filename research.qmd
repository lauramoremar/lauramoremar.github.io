...
- Tunnel ventilation simulations.
- Same FEM code base as in viscoelasticity (Femuss).
...
- Interface handling and numerical stability.
- Works overlapping with other lines (e.g., viscoelastic FSI).
