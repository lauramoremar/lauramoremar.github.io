...
<article class="research-card">
  <div class="research-card-media">
    <img class="carotid-cover" src="assets/images-carotida/portada-carotida.png" alt="Streamlines through a transparent three-dimensional carotid artery geometry">
    <span class="research-status current">Current research</span>
  </div>
  <div class="research-card-body">
    ...
    <a class="research-link" href="research_fsi-hemodynamics.qmd">Explore this research <span aria-hidden="true">→</span></a>
  </div>
</article>
...
<article class="research-card">
  <div class="research-card-media">
    <img src="assets/images-telescopes/not-telescope-sunset.webp" alt="Nordic Optical Telescope above a sea of clouds at Roque de los Muchachos Observatory">
    <span class="research-status applications">Selected applications</span>
    <a class="research-photo-credit" href="https://commons.wikimedia.org/wiki/File:Not_telescope_sunset_2001.jpg" target="_blank" rel="noopener">Bob Tubbs / Wikimedia Commons · Public domain</a>
  </div>
  <div class="research-card-body">
