...
![Scheme of the domain](assets/images-temperature/cylinder_scheme.png){fig-cap="Flow over a cylinder scheme" width=90%}
...
![Temperature distribution (K)](assets/images-temperature/cylinder_temperature_We4.png){fig-cap="Temperature distribution" width=90%}
...
![Stress distribution](assets/images-temperature/cylinder_stresses.png){fig-cap="Stresses distribution" width=60%}
